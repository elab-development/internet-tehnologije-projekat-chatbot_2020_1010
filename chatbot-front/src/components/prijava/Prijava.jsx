  ...
  return (
    <div className="login-form">
      <div className="login-form-data">
        ...
        <p style={{ marginTop: '10px' , color: 'white', fontWeight: "bold"}}>Ako nemate nalog, kliknite <Link to="/registracija" className="link-black" 
        style={{ textDecoration: "underline", color: 'blue'}}>ovde</Link> da se registrujete.</p>
      </div>
    </div>
  );
};
